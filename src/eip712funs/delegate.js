...
export async function delegate(web3, accounts, contract) {
    ...
    web3.currentProvider.sendAsync({
      ...
      sendAsync(web3, method, params, from, 
        async(v, r, s) => await contract.methods.delegate(v,r,s,signer, JSON.stringify(delegateParam)).send({ from: accounts[0] }))
    })
}